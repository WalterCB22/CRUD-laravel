...
<form action="/productos/{{$producto->id}}" method="POST">
 ...
 <div class="mb-3">
    ...
    <input id="codigo" name="nombre" type="text" class="form-control" tabindex="1" value=" {{ $producto->nombre }} ">    
  </div>
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input id="cantidad" name="marca" type="text" class="form-control" tabindex="3" value=" {{ $producto->marca_id }} ">
  </div>
  <div class="mb-3">
